package com.hskgroupafrica.comida.Fragments;
...
import com.hskgroupafrica.comida.Activities.AccountVerification;
...
import com.hskgroupafrica.comida.Activities.SplashScreen;
...
public class MyCartList extends Fragment {
    ...
    public void showLocationSelector() {
        ...
        dialogBuilder.setTitle("Select Restaurant");
        ...
        proceedToPayment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ((int) Double.parseDouble(CartListAdapter.totalAmountPayable) >= Integer.parseInt(SplashScreen.restaurantDetailResponseData.getMinorder())) {
                    ...
                    if (branch == null) {
                        Toast.makeText(getActivity(), "Please select restaurant", Toast.LENGTH_SHORT).show();
                        return;
                    }
